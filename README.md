...
This repository provides protocols and corresponding preprocessing for CellRank-based trajectory inference; we have
rendered all notebooks as a Jupyter book [here](https://theislab.github.io/cellrank_protocol/index.html).
